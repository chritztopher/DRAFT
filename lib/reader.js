...
class NewsletterReader {
    ...
    displayNewsletter(newsletter) {
        ...
        // Update subheader text with newsletter-specific highlight
        const subheaderElement = document.querySelector('.header-right p');
        if (subheaderElement && newsletter.highlight) {
            subheaderElement.textContent = newsletter.highlight;
        }
